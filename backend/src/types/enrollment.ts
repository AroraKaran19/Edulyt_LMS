...
export interface Enrollment {
  ...
  trialExpiresAt?: Date; // When the trial expires (for TTL auto-deletion)
  ...
  validUntil?: Date; // When the enrollment expires (4 years from enrolledAt for non-trial enrollments)
