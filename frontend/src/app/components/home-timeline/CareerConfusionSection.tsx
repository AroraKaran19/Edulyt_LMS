...
export default function CareerConfusionSection() {
  return (
    <div className="relative pl-10 sm:px-40 mb-13">
      {/* Marker row: 👋 + "Hello Students" */}
      <div className="flex items-center relative gap-4 -translate-x-8 sm:-translate-x-22">
        <TimelineMarkerIcon size="big">👋</TimelineMarkerIcon>
        <span className="text-lg sm:text-xl md:text-lg relative md:left-8 font-semibold text-gray-800">
          Hello Students
        </span>
      </div>
      ...
      >
        <div className="flex flex-col gap-8">
          ...
          {/* <TimelineSectionsWrapper svgStyle="h-11/12" className="xl:ml-4"> */}
            <div className="flex flex-col gap-4 pt-6 sm:pt-8">
              ...
              <DashedLineVertical
                className="left-[15px] sm:left-[178px] top-50 h-79 z-0"
                svgStyle="h-full"
              />
              {QUESTIONS.map((q, i) => (
                <div
        ...
        <div className="relative w-full sm:absolute sm:w-3/5 sm:right-0 sm:-bottom-10 hidden md:block">
          ...
          <div className="absolute -inset-y-40 left-0 top-48 w-1/4 h-3/4 bg-white/95 to-transparent blur-2xl z-10" />
