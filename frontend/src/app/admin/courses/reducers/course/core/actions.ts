...
export enum CourseActionType {
  ...
  SET_COURSE_TESTIMONIALS = "SET_COURSE_TESTIMONIALS",
...
export const courseActions = {
  ...
  setCourseCurriculumSource: (source: "upload" | "url" | undefined) => ({
    type: CourseActionType.SET_COURSE_CURRICULUM_SOURCE,
    payload: source,
  }),

  setCourseCurriculumS3Key: (s3Key: string) => ({
  ...
  // FAQ Management
  setCourseFaqs: (faqs: FAQ["_id"][]) => ({
    type: CourseActionType.SET_COURSE_FAQS,
    payload: faqs,
  }),

  addCourseFaq: (faqId: FAQ["_id"]) => ({
    type: CourseActionType.ADD_COURSE_FAQ,
    payload: faqId,
  }),

  updateCourseFaq: (faqIndex: number, updates: Partial<FAQ["_id"]>) => ({
  ...
  reorderCourseFaqs: (faqs: FAQ["_id"][]) => ({
    type: CourseActionType.REORDER_COURSE_FAQS,
    payload: faqs,
  }),

  // Testimonials Management
  setCourseTestimonials: (testimonials: Testimonial["_id"][]) => ({
    type: CourseActionType.SET_COURSE_TESTIMONIALS,
    payload: testimonials,
  }),

  addCourseTestimonial: (testimonialId: Testimonial["_id"]) => ({
    type: CourseActionType.ADD_COURSE_TESTIMONIAL,
    payload: testimonialId,
  }),

  updateCourseTestimonial: (testimonialIndex: number, updates: Partial<Testimonial["_id"]>) => ({
    type: CourseActionType.UPDATE_COURSE_TESTIMONIAL,
    payload: { testimonialIndex, updates },
  }),
