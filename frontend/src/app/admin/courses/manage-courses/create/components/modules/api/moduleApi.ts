...
export const updateModuleIdInStorage = (
  ...
  const existingModules = localStorage.getItem("course_modules");
  if (existingModules) {
    try {
      ...
      localStorage.setItem("course_modules", JSON.stringify(updatedModules));
    } catch (error) {
...
export const saveModuleToStorage = (moduleData: any): void => {
  ...
  try {
    ...
    console.log("Module saved to localStorage:", moduleData._id);
  } catch (error) {
    console.error("Error saving module to localStorage:", error);
  }
};
...
export const saveLessonToStorage = (lessonData: CourseLesson): void => {
  ...
  try {
    const existingLessons = localStorage.getItem("course_lessons");
    ...
    console.log("Lesson saved to localStorage:", lessonData._id);
  } catch (error) {
...
export const getLessonsFromStorage = (): CourseLesson[] => {
  ...
  try {
    ...
    console.error("Error getting lessons from localStorage:", error);
    return [];
  }
};
...
export const updateLessonIdInStorage = (
  ...
  try {
    ...
    if (existingLessons) {
      ...
      localStorage.setItem("course_lessons", JSON.stringify(updatedLessons));
    }
  } catch (error) {
...
export const saveContentToStorage = (contentData: Content): void => {
  ...
  try {
    const existingContent = localStorage.getItem("course_content");
    ...
    console.log("Content saved to localStorage:", contentData._id);
  } catch (error) {
...
export const updateContentIdInStorage = (
  ...
  try {
    ...
    if (existingContent) {
      ...
      localStorage.setItem("course_content", JSON.stringify(updatedContent));
    }
  } catch (error) {
