    ...
    return (
      <div className="w-full h-full flex items-center justify-center relative">
        ...
        <div className="relative z-20 flex flex-col items-center gap-4">
          ...
          <p className="text-lg font-medium text-gray-700">Redirecting to {isOAuthLoading ? 'authentication provider' : ''}...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="oauth-buttons w-full max-w-lg lg:max-w-full flex flex-col items-center justify-center gap-6">
        ...
        >
          <Image
            ...
            className="size-4"
          />
          <span>{isOAuthLoading ? "Signing in..." : "Sign In using Google"}</span>
        </WhiteButton>
        <WhiteButton
          className="w-full flex items-center justify-center gap-2 rounded-xl font-bold shadow-[inset_0_-2px_7px_0_rgba(183,159,255,0.22)]"
        ...
        >
          <Image
            ...
            className="size-4"
          />
          <span>{isOAuthLoading ? "Signing in..." : "Sign In using LinkedIn"}</span>
        </WhiteButton>
      </div>
      <p className="text-sm text-gray-500 text-center font-bold self-center">
        Don&apos;t have an account?{" "}
