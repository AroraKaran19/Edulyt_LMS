...
const PrerequisitesSection = () => {
  return (
    <div className="px-4 sm:px-6 lg:px-8 xl:pl-20 mt-12 sm:mt-16 lg:mt-24">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 items-center">
        ...
        {/* Right Section - Image */}
        <div className="h-full w-full flex items-center justify-center lg:justify-end sm:px-30">
