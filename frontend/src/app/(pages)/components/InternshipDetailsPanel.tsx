    ...
    <div className="lg:col-span-1">
      <div className="bg-white rounded-2xl shadow-lg p-6 lg:p-8 space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <Link
              ...
              className="text-lg font-semibold text-[#F77124] hover:underline"
            >
              Join Now
            </Link>
          </div>
          ...
          {socialLinks.map((social, index) => {
            ...
            return (
              <Link
                ...
                target="_blank"
                rel="noopener noreferrer"
                className={cn("transition-colors duration-200", social.color)}
        ...
        <div className="space-y-3">
          <OrangeButton className="w-full py-4 text-lg font-semibold">
            <Phone className="w-5 h-5 mr-2 inline" />
            Call Us: {internshipDetails.phoneNumber}
          </OrangeButton>
          <WhiteButton className="w-full py-4 text-lg font-semibold border-2 border-[#F77124] text-[#F77124] hover:bg-[#F77124]/10">
            Apply Now
          </WhiteButton>
        </div>
      </div>
...
export default InternshipDetailsPanel;
