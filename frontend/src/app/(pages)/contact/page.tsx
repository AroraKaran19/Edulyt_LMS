...
import { Mail, MapPin, Phone, Clock, MessageSquare, Send, Users, Globe, Award } from 'lucide-react'
						...
						<FlexBox direction="col" className="bg-white rounded-2xl p-8 shadow-lg border border-orange-100">
							...
							<div className="grid md:grid-cols-3 gap-8">
								...
								<FlexBox direction="col" className="items-center text-center">
									...
									<a href="tel:+918929252575" className="text-blue-600 font-semibold hover:text-blue-700 transition-colors">
										+91-8929252575
									</a>
								</FlexBox>
								<FlexBox direction="col" className="items-center text-center">
						...
						<FlexBox direction="col" className="bg-white rounded-2xl p-8 shadow-lg border border-orange-100">
							...
							<form className="space-y-6">
								...
								<div className="flex justify-center">
									<button
										type="submit"
										className="bg-gradient-to-r from-orange-600 to-orange-700 text-white px-8 py-3 rounded-lg font-semibold hover:from-orange-700 hover:to-orange-800 transition-all duration-300 flex items-center gap-2 shadow-lg hover:shadow-xl"
									>
								...
								<div>
									...
									<div className="space-y-3">
										<div className="bg-green-50 p-4 rounded-lg border border-green-200">
											<p className="text-green-800 font-semibold">Email Support</p>
											<p className="text-green-700">Within 24 hours</p>
										</div>
										<div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
											<p className="text-blue-800 font-semibold">Phone Support</p>
						...
						<FlexBox direction="col" className="bg-gradient-to-r from-orange-600 to-orange-700 text-white rounded-2xl p-8 shadow-lg">
							...
							<div className="grid md:grid-cols-3 gap-8">
								...
								<FlexBox direction="col" className="items-center text-center">
									...
									<p className="text-orange-100">
										Access your courses anytime, anywhere with our online learning platform.
									</p>
								</FlexBox>
								<FlexBox direction="col" className="items-center text-center">
									<div className="bg-white/20 p-4 rounded-full mb-4">
									...
									<h3 className="text-xl font-semibold mb-3">Certified Courses</h3>
									<p className="text-orange-100">
										Earn recognized certificates upon completion of our professional courses.
									</p>
								</FlexBox>
							</div>
						</FlexBox>
							...
							<div className="space-y-6">
								<div className="border border-gray-200 rounded-lg p-6">
									...
									<p className="text-gray-700">
										You can enroll in any course by visiting our course catalog, selecting your desired course, and following the enrollment process. Payment can be made securely through our platform.
									</p>
								</div>
								<div className="border border-gray-200 rounded-lg p-6">
									<h3 className="text-lg font-semibold text-gray-800 mb-2">
									...
									<p className="text-gray-700">
										We accept various payment methods including credit/debit cards, net banking, UPI, and digital wallets. All payments are processed securely.
									</p>
								</div>
								<div className="border border-gray-200 rounded-lg p-6">
									<h3 className="text-lg font-semibold text-gray-800 mb-2">
									...
									<p className="text-gray-700">
										Please refer to our Cancellation & Refund Policy for detailed information about our refund process and terms.
									</p>
								</div>
								<div className="border border-gray-200 rounded-lg p-6">
									<h3 className="text-lg font-semibold text-gray-800 mb-2">
									...
									<p className="text-gray-700">
										Course access duration varies by course. Most courses provide lifetime access, while some may have specific time limits. Check individual course details for specific information.
									</p>
								</div>
							</div>
						</FlexBox>
						...
						<FlexBox direction="col" className="bg-white rounded-2xl p-8 shadow-lg border border-orange-100 text-center">
							<div className="bg-orange-100 p-6 rounded-xl">
								...
								<p className="text-orange-700 text-lg">
									Our dedicated team is committed to providing you with the best learning experience. Don&apos;t hesitate to reach out!
								</p>
							</div>
						</FlexBox>
					</section>
