				...
				<div className="container mx-auto px-6">
					<FlexBox direction="col" className="items-center text-center">
						...
						<p className="text-xl text-orange-100 max-w-2xl">
							Your security is our priority. Learn about the measures we take to protect your data.
						</p>
				...
				<div className="max-w-4xl mx-auto">
						...
						<FlexBox direction="col" className="bg-white rounded-2xl p-8 shadow-lg border border-orange-100">
							...
							<div className="mb-8">
								<FlexBox className="items-center gap-3 mb-4">
									...
									<h3 className="text-2xl font-semibold text-gray-800">Encryption</h3>
								</FlexBox>
								<p className="text-gray-700 leading-relaxed">
									We use industry-standard encryption protocols to protect your data during transmission and storage.
									All sensitive information, including personal and payment details, is encrypted using Secure Socket Layer (SSL) technology.
								</p>
							</div>
							...
							<div>
								<FlexBox className="items-center gap-3 mb-4">
									...
									<h3 className="text-2xl font-semibold text-gray-800">Regular Audits</h3>
								</FlexBox>
								<p className="text-gray-700 leading-relaxed">
									We conduct regular security audits and assessments to identify and address potential vulnerabilities.
									Our security team continuously monitors our systems to ensure they meet the highest security standards.
								</p>
							</div>
						</FlexBox>
					</section>
					...
					<section className="mb-12">
						<FlexBox direction="col" className="bg-white rounded-2xl p-8 shadow-lg border border-orange-100">
							...
							<p className="text-gray-700 mb-6 leading-relaxed">
								While we take extensive measures to protect your information, it is also important for users to take steps to safeguard their accounts.
							...
							<div className="space-y-4">
								<div className="bg-green-50 p-6 rounded-xl border border-green-200">
									<FlexBox className="items-center gap-3 mb-3">
										...
										<h4 className="font-semibold text-green-800">Use a strong password:</h4>
									</FlexBox>
									<p className="text-gray-700">
										Create a password that is difficult to guess and contains a mix of letters, numbers, and special characters.
									</p>
								</div>
								<div className="bg-blue-50 p-6 rounded-xl border border-blue-200">
									<FlexBox className="items-center gap-3 mb-3">
										<Shield className="w-5 h-5 text-blue-600" />
										<h4 className="font-semibold text-blue-800">Keep your password confidential:</h4>
									</FlexBox>
									<p className="text-gray-700">
										Do not share your password with others, and avoid using the same password across multiple sites.
									</p>
								</div>
								<div className="bg-purple-50 p-6 rounded-xl border border-purple-200">
									<FlexBox className="items-center gap-3 mb-3">
										<CheckCircle className="w-5 h-5 text-purple-600" />
										<h4 className="font-semibold text-purple-800">Update your password regularly:</h4>
									</FlexBox>
									<p className="text-gray-700">
					...
					<section className="mb-12">
						<FlexBox direction="col" className="bg-white rounded-2xl p-8 shadow-lg border border-orange-100">
							...
							<p className="text-gray-700 mb-6 leading-relaxed">
								In the event of a data breach or security incident, we have a comprehensive incident response plan in place.
								This plan includes:
							</p>
							<div className="grid md:grid-cols-2 gap-6">
								<div className="space-y-4">
									<div className="bg-red-50 p-4 rounded-xl border border-red-200">
										...
										<p className="text-gray-700 text-sm">
											Identifying and isolating the affected systems to prevent further damage.
										</p>
									</div>
									<div className="bg-yellow-50 p-4 rounded-xl border border-yellow-200">
										<h4 className="font-semibold text-yellow-800 mb-2">Investigation:</h4>
										<p className="text-gray-700 text-sm">
								...
								<div className="space-y-4">
									<div className="bg-blue-50 p-4 rounded-xl border border-blue-200">
										<h4 className="font-semibold text-blue-800 mb-2">Notification:</h4>
										<p className="text-gray-700 text-sm">
											Informing affected users and regulatory authorities, as required, about the incident and the steps being taken to mitigate its impact.
										</p>
									</div>
									<div className="bg-green-50 p-4 rounded-xl border border-green-200">
										<h4 className="font-semibold text-green-800 mb-2">Remediation:</h4>
										<p className="text-gray-700 text-sm">
					...
					<section className="mb-12">
						<FlexBox direction="col" className="bg-white rounded-2xl p-8 shadow-lg border border-orange-100">
							...
							<p className="text-gray-700 leading-relaxed text-lg">
								We work with reputable third-party service providers to deliver our services. These providers are carefully selected
								based on their security practices and must comply with our security standards. We also regularly review their security
								measures to ensure they continue to meet our requirements.
							</p>
						</FlexBox>
					</section>
					...
					<section className="mb-12">
						<FlexBox direction="col" className="bg-white rounded-2xl p-8 shadow-lg border border-orange-100">
							...
							<p className="text-gray-700 leading-relaxed text-lg">
								We may update our Security Policy from time to time to reflect changes in technology, legal requirements,
								or our security practices. Any updates will be posted on this page, and we will update the &quot;Last updated&quot;
								date at the top of the policy. We encourage you to review this policy periodically to stay informed about
