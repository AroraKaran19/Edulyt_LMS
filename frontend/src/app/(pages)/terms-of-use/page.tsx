				...
				<div className="max-w-4xl mx-auto">
						...
						<FlexBox direction="col" className="bg-white rounded-2xl p-8 shadow-lg border border-orange-100">
							...
							<div className="mb-8">
								...
								<p className="text-gray-700 leading-relaxed">
									To use Edulyt, you must be at least 18 years old or have the consent of a parent or guardian if you are a minor.
							...
							<div className="mb-8">
								<FlexBox className="items-center gap-3 mb-4">
									...
									<h3 className="text-2xl font-semibold text-gray-800">Account Registration</h3>
								</FlexBox>
							...
							<div>
								<FlexBox className="items-center gap-3 mb-4">
									...
									<h3 className="text-2xl font-semibold text-gray-800">Use Restrictions</h3>
								</FlexBox>
								<p className="text-gray-700 mb-4">
									You agree not to:
								</p>
								<ul className="list-disc list-inside space-y-2 text-gray-700 ml-4">
									...
									<li>Use any automated system, including &quot;robots,&quot; &quot;spiders,&quot; or &quot;offline readers,&quot; to access the platform in a manner that sends more request messages to our servers than a human can reasonably produce in the same period by using a conventional online web browser</li>
									<li>Attempt to interfere with or compromise the system integrity or security or decipher any transmissions to or from the servers running the platform</li>
						...
						<FlexBox direction="col" className="bg-white rounded-2xl p-8 shadow-lg border border-orange-100">
							...
							<div className="mb-8">
								<FlexBox className="items-center gap-3 mb-4">
									...
									<h3 className="text-2xl font-semibold text-gray-800">User Content</h3>
								</FlexBox>
								<p className="text-gray-700 leading-relaxed">
									You may have the opportunity to post, upload, or otherwise make available content through our platform (&quot;User Content&quot;).
									You retain ownership of your User Content, but by making it available on or through the platform, you grant us a worldwide,
									non-exclusive, royalty-free, transferable, sublicensable license to use, reproduce, modify, distribute, prepare derivative
									works of, display, and perform your User Content in connection with the operation and promotion of the platform.
								</p>
							</div>
							...
							<div>
								<FlexBox className="items-center gap-3 mb-4">
									...
									<h3 className="text-2xl font-semibold text-gray-800">Our Content</h3>
								</FlexBox>
								<p className="text-gray-700 leading-relaxed">
									All content provided by us on the platform, including text, graphics, logos, images, and software, is the property of
									Edulyt or our licensors and is protected by copyright, trademark, and other intellectual property laws. You may not use,
					...
					<section className="mb-12">
						<FlexBox direction="col" className="bg-white rounded-2xl p-8 shadow-lg border border-orange-100">
							...
							<p className="text-gray-700 leading-relaxed text-lg">
								...
								without notice and liability, for any reason, including if you violate these Terms of Use.
							</p>
						</FlexBox>
					</section>
					...
					<section className="mb-12">
						<FlexBox direction="col" className="bg-white rounded-2xl p-8 shadow-lg border border-orange-100">
							...
							<div className="bg-yellow-50 p-6 rounded-xl border border-yellow-200">
								<p className="text-gray-700 leading-relaxed text-lg">
									The platform is provided on an &quot;as is&quot; and &quot;as available&quot; basis. We disclaim all warranties of any kind,
									whether express or implied, including, but not limited to, the implied warranties of merchantability,
									fitness for a particular purpose, and non-infringement. We do not warrant that the platform will be uninterrupted,
									secure, or error-free, or that any defects or errors will be corrected.
								</p>
							</div>
						</FlexBox>
					</section>
					...
					<section className="mb-12">
						<FlexBox direction="col" className="bg-white rounded-2xl p-8 shadow-lg border border-orange-100">
							...
							<p className="text-gray-700 mb-6">
								To the fullest extent permitted by law, in no event will Edulyt, its affiliates, officers, directors, employees,
					...
					<section className="mb-12">
						<FlexBox direction="col" className="bg-white rounded-2xl p-8 shadow-lg border border-orange-100">
							...
							<p className="text-gray-700 leading-relaxed text-lg">
								These Terms of Use and any disputes related to them will be governed by and construed in accordance with
					...
					<section className="mb-12">
						<FlexBox direction="col" className="bg-white rounded-2xl p-8 shadow-lg border border-orange-100">
							...
							<p className="text-gray-700 leading-relaxed text-lg">
								We may update these Terms of Use from time to time. Any changes will be posted on this page, and we will
								update the &quot;Last updated&quot; date at the top of the terms. Your continued use of the platform after the changes
