...
interface CourseEnrollCartProps {
  course: Course;
  planType: "elite" | "essential";
}

const CourseEnrollCart = ({ course, planType }: CourseEnrollCartProps) => {
                  ...
                  <div className="relative rounded-xl sm:rounded-[18px] overflow-hidden">
                    ...
                    <div className="absolute bottom-2 sm:bottom-3 left-2 sm:left-3 px-1 sm:px-2 w-full pr-4 sm:pr-6">
                      ...
                      <div className="mb-2 sm:mb-3">
                        <p
                          className="font-bold text-xs sm:text-sm md:text-lg font-plus-jakarta text-[#F7AD24] px-2 py-1 rounded"
                          style={{
                            background:
                              "linear-gradient(89.99deg, rgba(247, 191, 36, 0.23) 0.19%, rgba(255, 217, 195, 0) 99.99%)",
                          }}
                        >
                          Best seller
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2 mb-2 sm:mb-3">
                        <div className="flex items-center gap-1">
                          <Star
                            className="w-3 h-3 sm:w-4 sm:h-4 text-[#F7AD24]"
                            fill="#F7AD24"
                          />
                          <span className="font-bold text-xs sm:text-sm md:text-lg font-plus-jakarta text-[#F7AD24]">
                            4.5 Rating
                          </span>
                        </div>
                      ...
                      <div className="flex gap-1 sm:gap-2 overflow-x-auto">
                        <div className="bg-[#EEEEEE] rounded-full sm:rounded-[34px] p-1 sm:p-[2px] border-2 border-white flex items-center gap-1 sm:gap-2 flex-shrink-0">
                          <Image
                            ...
                            width={16}
                            height={16}
                            className="sm:w-5 sm:h-5 md:w-6 md:h-6 rounded-full border border-white"
                          />
                          <span className="text-xs sm:text-sm text-gray-700 font-medium hidden md:inline pr-1 sm:pr-2">
                            John Doe
                          </span>
                          <span className="text-xs sm:text-sm text-gray-700 font-medium md:hidden pr-1 sm:pr-2">
                            JD
                          </span>
                        </div>
                        <div className="bg-[#EEEEEE] rounded-full sm:rounded-[34px] p-1 sm:p-[2px] border-2 border-white flex items-center gap-1 sm:gap-2 flex-shrink-0">
                        ...
                        <div className="bg-[#EEEEEE] rounded-full sm:rounded-[34px] p-1 sm:p-[2px] border-2 border-white flex items-center gap-1 sm:gap-2 flex-shrink-0">
                          <span className="text-xs sm:text-sm text-gray-700 font-medium px-2 py-1">
                            +1
                          </span>
                        </div>
                      </div>
        ...
        <div className="w-full lg:flex-7 flex flex-col">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 sm:gap-2 w-full bg-white rounded-2xl sm:rounded-3xl p-3 sm:p-2 mb-4">
              ...
              <div className="flex items-center w-full sm:w-auto">
                ...
                <div
                  className={`flex items-center gap-1 sm:gap-2 ${
                    currentStep >= 1
                      ? "bg-[#23CB0221] border border-[#0000000F]"
                      : "bg-white border border-[#D4E9D1]"
                  } rounded-full px-2 sm:px-3 py-2`}
                >
                  <Image
                    src="/check-cart.svg"
                    alt="check"
                  ...
                  />
                  <span className="text-sm sm:text-base font-bold font-plus-jakarta text-[#0E4E01]">
                    Application
                  </span>
                </div>
                ...
                <div
                  className={`flex items-center gap-1 sm:gap-2 ${
                    currentStep >= 2
                      ? "bg-[#23CB0221] border border-[#0000000F]"
                      : "bg-white border border-[#D4E9D1]"
                  } rounded-full px-2 sm:px-3 py-2 ml-2 sm:ml-0`}
                >
                  <Image
                    src="/check-cart.svg"
                    alt="check"
            ...
            {course.brochure && course.brochure !== "" && (
              <button
                type="button"
                className="flex items-center gap-2 bg-[#000000] hover:bg-gray-900 text-white px-3 sm:px-5 py-2 sm:py-3 rounded-xl sm:rounded-[18px] transition-colors w-full sm:w-auto justify-center cursor-pointer"
              ...
              >
                <span className="text-xs sm:text-sm font-bold font-plus-jakarta text-white">
                  Download Brochure
                </span>
          ...
          <div className="w-full h-full flex flex-col xl:flex-row gap-4">
            ...
            <div className="w-full xl:flex-1">
              ...
              {currentStep === 3 && (
                <EnrollmentDetails
                  course={course}
                  planType={planType as "elite" | "essential"}
                />
              )}
            </div>
      ...
      <div className="w-full flex flex-col gap-4">
        <SectionContainer>
          <div className="section-header flex flex-col gap-2 sm:gap-4 text-center mb-6 sm:mb-8">
            <CourseTitle
              title="FAQ"
              className="text-text-primary text-2xl sm:text-3xl md:text-[40px]"
            />
            <p
              className="text-sm sm:text-base text-center text-text-primary font-normal px-2 sm:px-4 lg:px-0"
          ...
          <div className="w-full flex flex-col gap-2 sm:gap-3 md:gap-4 min-h-[200px] sm:min-h-[250px] md:min-h-[300px]">
            {course?.faqs &&
              course.faqs.map((faq: FAQ, index: number) => (
                <div
                  key={index}
                  className="border border-[#00000014] rounded-xl sm:rounded-2xl bg-[#F3F3F3] overflow-hidden"
                >
                  <button
