...
const ProfilePage = () => {
  ...
  /**
   * Keeps digits and a leading "+". A country code the visitor types survives —
   * this used to rewrite everything to +91, so a foreign number was impossible
   * to enter. Bare digits are still assumed Indian, as before.
   */
  const handlePhoneInput = (field: string, inputValue: string) => {
    ...
    if (filteredValue.startsWith("+")) return "+" + digits.slice(0, 15);

    return "+91" + digits.slice(0, 12);
  };
                ...
                <div>
                  ...
                  {!errors.whatsappNumber && (
                    <p className="mt-1 text-xs text-gray-500">
                      Include the country code, e.g. +919876543210 or +447911123456
                    </p>
                  )}
                </div>
                <DateSelector
