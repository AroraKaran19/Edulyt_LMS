...
const AddNotes = ({ onClose, onSave, onNoteContentChange, noteContent }: { onClose: () => void, onSave: () => void, onCancel: () => void, onNoteContentChange: (content: string) => void, noteContent: string }) => {
    return (
            ...
            <div className=" bg-white border border-[#00000021] shadow-[0px_-3px_3.7px_0px_#0146E721_inset] px-4 py-2 rounded-xl flex items-center justify-between">
                <div className="flex items-center gap-4rounded-2xl" >
                    ...
                    <div className="flex items-center gap-2 cursor-pointer">
                        <span className="text-base font-plus-jakarta font-bold text-[#2B1508]">Style</span>
