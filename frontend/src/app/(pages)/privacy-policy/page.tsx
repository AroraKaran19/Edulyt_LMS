						...
						<FlexBox direction="col" className="bg-white rounded-2xl p-8 shadow-lg border border-orange-100">
							...
							<div className="mb-8">
								...
								<p className="text-gray-700 mb-4">
									When you use our platform, we may collect personal information that you provide to us, including but not limited to:
								</p>
							...
							<div>
								<FlexBox className="items-center gap-3 mb-4">
									...
									<h3 className="text-2xl font-semibold text-gray-800">Non-Personal Information</h3>
								</FlexBox>
								<p className="text-gray-700 mb-4">
					...
					<section className="mb-12">
						<FlexBox direction="col" className="bg-white rounded-2xl p-8 shadow-lg border border-orange-100">
							...
							<div className="grid md:grid-cols-2 gap-4">
								...
								<ul className="list-disc list-inside space-y-3 text-gray-700">
									<li>Analyze and monitor usage trends to improve our platform</li>
						...
						<FlexBox direction="col" className="bg-white rounded-2xl p-8 shadow-lg border border-orange-100">
							...
							<div className="space-y-6">
								<div className="bg-orange-50 p-6 rounded-xl">
									<h4 className="font-semibold text-orange-800 mb-2">With service providers:</h4>
								...
								<div className="bg-blue-50 p-6 rounded-xl">
									<h4 className="font-semibold text-blue-800 mb-2">For legal reasons:</h4>
									<p className="text-gray-700">
										We may disclose your information if required to do so by law or in response to a valid request
										from a law enforcement agency or other governmental bodies.
									</p>
								</div>
								<div className="bg-green-50 p-6 rounded-xl">
									<h4 className="font-semibold text-green-800 mb-2">Business transfers:</h4>
									<p className="text-gray-700">
					...
					<section className="mb-12">
						<FlexBox direction="col" className="bg-white rounded-2xl p-8 shadow-lg border border-orange-100">
							...
							<p className="text-gray-700 leading-relaxed text-lg">
								...
								from unauthorized access, use, or disclosure. However, no internet or email transmission is ever
								fully secure or error-free. Please keep this in mind when disclosing any personal information to us online.
							</p>
						</FlexBox>
					</section>
