...
const AboutPage = () => {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-orange-50 to-white">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="bg-linear-to-br from-orange-100 to-orange-200 rounded-3xl p-8">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {team.map((member, index) => (
              <div
                key={index}
                className="bg-linear-to-br from-orange-50 to-white rounded-2xl p-6 border border-orange-100 text-center"
              >
      ...
      {/* CTA Section */}
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-linear-to-r from-[#F77124] to-[#E65A1A]">
