...
import { institutePartnerStudentsJson } from "../../dummyData";
import OrangeButton from "@/components/ui/buttons/OrangeButton";

const data = institutePartnerStudentsJson;
const statIcons = [
  <Users key="total" className="size-5" />,
  <UserCheck key="active" className="size-5" />,
  <CheckCircle key="enrollments" className="size-5" />,
  <CheckCircle key="completed" className="size-5" />,
];

export default function InstitutePartnerStudentsPage() {
  return (
          ...
          <table className="w-full text-sm min-w-[760px]">
            <thead>
              <tr className="text-left text-[#667085] border-b border-[#F2F4F7]">
                ...
                <th className="pb-3 font-medium">Enrolment date</th>
