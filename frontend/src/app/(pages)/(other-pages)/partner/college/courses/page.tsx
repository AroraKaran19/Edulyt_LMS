...
import { collegePartnerCoursesJson } from "../../dummyData";

const data = collegePartnerCoursesJson;
const statIcons = [
  <BookOpen key="totalCourses" className="size-5" />,
  <Users key="totalEnrollments" className="size-5" />,
  <CheckCircle key="activeCourses" className="size-5" />,
  <GraduationCap key="newEnrollments" className="size-5" />,
];

export default function CollegePartnerCoursesPage() {
  return (
