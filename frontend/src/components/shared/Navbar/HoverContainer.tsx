...
const HoverContainer = ({
  ...
  return (
    <div
      className={`fixed top-[78px] h-[40vh] left-0 right-0 z-40 bg-white/95 backdrop-blur-md shadow-[0_0_1px_2px_rgba(0,0,0,0.1)] hidden lg:block px-8 rounded-b-4xl transition-all duration-300 ${
        isVisible
