...
const getInitialFormData = (
  ...
  return {
    ...
    thumbnailS3Key: "",
    enquiryImage: "",
    enquiryImageSource: "upload",
    enquiryImageS3Key: "",
    preRequisitesImage: "",
    preRequisitesImageSource: "upload",
    preRequisitesImageS3Key: "",
...
const transformFormDataToInternship = (
  ...
  return {
    ...
    enquiryImage: formData.enquiryImage ?? "",
    preRequisitesImage: formData.preRequisitesImage ?? "",
...
const transformInternshipToFormData = (
  ...
  return {
    ...
    thumbnailSource: "url",
    thumbnailS3Key: "",
    enquiryImage: internship.enquiryImage || "",
    enquiryImageSource: "url",
    enquiryImageS3Key: "",
    preRequisitesImage: internship.preRequisitesImage || "",
    preRequisitesImageSource: "url",
    preRequisitesImageS3Key: "",
