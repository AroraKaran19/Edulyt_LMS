            ...
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3 sm:gap-4 mb-4">
              ...
              <div className="flex flex-col sm:flex-row gap-2 sm:items-center sm:justify-end w-full lg:w-auto">
                ...
                <div className="flex gap-2 order-2 sm:order-0">
                  <button
                    type="button"
                    className="flex items-center gap-1 border border-[#00000026] rounded-xl px-3 sm:px-4 md:px-5 py-2 sm:py-3 text-xs sm:text-sm font-bold text-[#2B1508] hover:bg-gray-200 cursor-pointer"
                  >
                ...
                >
                  <div>
                    <div className="relative w-full h-24 xs:h-28 sm:h-32 md:h-36 rounded-xl overflow-hidden mb-2 sm:mb-3 pt-2 sm:pt-4 px-2 sm:px-3 border border-[#00000017]">
                      <ImageComponent
                        src="/certificates-user-icon.svg"
                        alt="certificate"
                        width={259}
                        height={188}
                    ...
                    <div className="flex gap-1 sm:gap-2 overflow-x-auto pb-1">
                      <div className="bg-[#EEEEEE] rounded-[34px] p-[2px] border-2 border-white flex items-center gap-1 sm:gap-2 flex-shrink-0">
                        <ImageComponent
                          ...
                          width={16}
                          height={16}
                          className="w-4 h-4 sm:w-5 sm:h-5 md:w-6 md:h-6 rounded-full border border-white"
                        />
                        ...
                        <span className="text-xs sm:text-sm text-gray-700 font-medium sm:hidden">
                          {certificate?.user?.name?.slice(0, 2)}
                        </span>
                      </div>
