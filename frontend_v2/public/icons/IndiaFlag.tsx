...
const IndianFlagIcon = ({ ...props }: React.SVGProps<SVGSVGElement>) => {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M0 30H30V0H0V30Z" fill="url(#pattern0_1130_681)" />
      <defs>
        <pattern
          id="pattern0_1130_681"
          patternContentUnits="objectBoundingBox"
          width="1"
          height="1"
        >
          <use xlinkHref="#image0_1130_681" transform="scale(0.015625)" />
        </pattern>
        <image
          id="image0_1130_681"
          width="64"
